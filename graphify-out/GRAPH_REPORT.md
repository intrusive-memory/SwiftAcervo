...
## Summary
- 3257 nodes · 6794 edges · 183 communities (155 shown, 28 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 278 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `082cb0d2`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_CDN S3 Client & Credentials|CDN S3 Client & Credentials]]
- [[_COMMUNITY_Model Row UI Controller|Model Row UI Controller]]
- [[_COMMUNITY_Manifest Command Tests|Manifest Command Tests]]
- [[_COMMUNITY_CLI Tool Errors|CLI Tool Errors]]
- [[_COMMUNITY_HuggingFace Client Tests|HuggingFace Client Tests]]
- [[_COMMUNITY_Fuzzy Search Tests|Fuzzy Search Tests]]
- [[_COMMUNITY_Integrity Verification Tests|Integrity Verification Tests]]
- [[_COMMUNITY_Acervo Manager Actor|Acervo Manager Actor]]
- [[_COMMUNITY_CDN Manifest Codable Models|CDN Manifest Codable Models]]
- [[_COMMUNITY_Component Hydration|Component Hydration]]
- [[_COMMUNITY_Delete From CDN Tests|Delete From CDN Tests]]
- [[_COMMUNITY_Publish Model Tests|Publish Model Tests]]
- [[_COMMUNITY_S3 CDN Client Tests|S3 CDN Client Tests]]
- [[_COMMUNITY_Downloader URL Building Tests|Downloader URL Building Tests]]
- [[_COMMUNITY_Path Resolution Tests|Path Resolution Tests]]
- [[_COMMUNITY_Acervo Error Cases|Acervo Error Cases]]
- [[_COMMUNITY_Component Integration Tests|Component Integration Tests]]
- [[_COMMUNITY_Model Name Parsing Tests|Model Name Parsing Tests]]
- [[_COMMUNITY_CDN Download Internals|CDN Download Internals]]
- [[_COMMUNITY_Model Availability Tests|Model Availability Tests]]
- [[_COMMUNITY_EM2 Validity Oracle Tests|EM2 Validity Oracle Tests]]
- [[_COMMUNITY_Manager Statistics Tests|Manager Statistics Tests]]
- [[_COMMUNITY_Hydration Tests|Hydration Tests]]
- [[_COMMUNITY_Levenshtein Distance|Levenshtein Distance]]
- [[_COMMUNITY_Three-State Availability Tests|Three-State Availability Tests]]
- [[_COMMUNITY_Concurrent Download Tests|Concurrent Download Tests]]
- [[_COMMUNITY_Slug Availability Tests|Slug Availability Tests]]
- [[_COMMUNITY_Telemetry Cache State Enums|Telemetry Cache State Enums]]
- [[_COMMUNITY_Component Registry Tests|Component Registry Tests]]
- [[_COMMUNITY_Ship Queue Python Tool|Ship Queue Python Tool]]
- [[_COMMUNITY_Manifest Cache|Manifest Cache]]
- [[_COMMUNITY_SigV4 Request Signing|SigV4 Request Signing]]
- [[_COMMUNITY_Local Housekeeping & GC Tests|Local Housekeeping & GC Tests]]
- [[_COMMUNITY_Model Discovery Tests|Model Discovery Tests]]
- [[_COMMUNITY_EnsureAvailable Integration Tests|EnsureAvailable Integration Tests]]
- [[_COMMUNITY_Multi-File Rollback Tests|Multi-File Rollback Tests]]
- [[_COMMUNITY_Project Documentation Files|Project Documentation Files]]
- [[_COMMUNITY_Acervo Static API|Acervo Static API]]
- [[_COMMUNITY_Component Handle Tests|Component Handle Tests]]
- [[_COMMUNITY_Component Descriptor Tests|Component Descriptor Tests]]
- [[_COMMUNITY_Telemetry Mock Reporter Tests|Telemetry Mock Reporter Tests]]
- [[_COMMUNITY_Ship Command|Ship Command]]
- [[_COMMUNITY_Component Access Tests|Component Access Tests]]
- [[_COMMUNITY_Component Catalog Tests|Component Catalog Tests]]
- [[_COMMUNITY_Models List UI Components|Models List UI Components]]
- [[_COMMUNITY_Component Download Tests|Component Download Tests]]
- [[_COMMUNITY_Slug Delete Model Tests|Slug Delete Model Tests]]
- [[_COMMUNITY_CDN Publish & Delete Progress|CDN Publish & Delete Progress]]
- [[_COMMUNITY_Auto-Hydrate Tests|Auto-Hydrate Tests]]
- [[_COMMUNITY_CDN Manifest Tests|CDN Manifest Tests]]
- [[_COMMUNITY_Resumable Download Tests|Resumable Download Tests]]
- [[_COMMUNITY_Slug EnsureAvailable Tests|Slug EnsureAvailable Tests]]
- [[_COMMUNITY_Telemetry Event Types|Telemetry Event Types]]
- [[_COMMUNITY_Upload Command Tests|Upload Command Tests]]
- [[_COMMUNITY_Component Descriptor Model|Component Descriptor Model]]
- [[_COMMUNITY_Telemetry Integrity Failure Tests|Telemetry Integrity Failure Tests]]
- [[_COMMUNITY_Manifest Persistence Tests|Manifest Persistence Tests]]
- [[_COMMUNITY_Recache Command|Recache Command]]
- [[_COMMUNITY_Delete Progress & Manager|Delete Progress & Manager]]
- [[_COMMUNITY_Component Readiness API|Component Readiness API]]
- [[_COMMUNITY_Component In-Flight Tests|Component In-Flight Tests]]
- [[_COMMUNITY_Models List Grouping Tests|Models List Grouping Tests]]
- [[_COMMUNITY_Ship Command Tests|Ship Command Tests]]
- [[_COMMUNITY_Verify Command|Verify Command]]
- [[_COMMUNITY_EnsureAvailable API|EnsureAvailable API]]
- [[_COMMUNITY_Model Download Manager Tests|Model Download Manager Tests]]
- [[_COMMUNITY_Slug Manifest API|Slug Manifest API]]
- [[_COMMUNITY_Integrity Verification Helper|Integrity Verification Helper]]
- [[_COMMUNITY_Bundle Component Tests|Bundle Component Tests]]
- [[_COMMUNITY_Error Path Tests|Error Path Tests]]
- [[_COMMUNITY_Component Telemetry Tests|Component Telemetry Tests]]
- [[_COMMUNITY_SigV4 Signer Tests|SigV4 Signer Tests]]
- [[_COMMUNITY_Delete Command|Delete Command]]
- [[_COMMUNITY_Model Row Controller Tests|Model Row Controller Tests]]
- [[_COMMUNITY_Stored Model Edit Sheet Tests|Stored Model Edit Sheet Tests]]
- [[_COMMUNITY_In-Flight Downloads Dedup|In-Flight Downloads Dedup]]
- [[_COMMUNITY_Validity Oracle|Validity Oracle]]
- [[_COMMUNITY_CLI Mock URL Protocol|CLI Mock URL Protocol]]
- [[_COMMUNITY_Download Progress Tests|Download Progress Tests]]
- [[_COMMUNITY_Cache Miss Reason Tests|Cache Miss Reason Tests]]
- [[_COMMUNITY_CDN Manifest Integrity Tests|CDN Manifest Integrity Tests]]
- [[_COMMUNITY_Local Access Tests|Local Access Tests]]
- [[_COMMUNITY_Edit Sheet Draft Tests|Edit Sheet Draft Tests]]
- [[_COMMUNITY_SwiftData Schema Migration|SwiftData Schema Migration]]
- [[_COMMUNITY_Secure Download Session|Secure Download Session]]
- [[_COMMUNITY_Bundle Reregister Canary Tests|Bundle Reregister Canary Tests]]
- [[_COMMUNITY_Concurrency Tests|Concurrency Tests]]
- [[_COMMUNITY_Download API Tests|Download API Tests]]
- [[_COMMUNITY_Acervo Error Tests|Acervo Error Tests]]
- [[_COMMUNITY_Manifest Fetch Tests|Manifest Fetch Tests]]
- [[_COMMUNITY_Mission Agent Docs|Mission Agent Docs]]
- [[_COMMUNITY_Ship Command HF Stub Tests|Ship Command HF Stub Tests]]
- [[_COMMUNITY_Archived Requirements Docs|Archived Requirements Docs]]
- [[_COMMUNITY_CLI Command Definitions|CLI Command Definitions]]
- [[_COMMUNITY_Path & Availability API|Path & Availability API]]
- [[_COMMUNITY_Component Downloads API|Component Downloads API]]
- [[_COMMUNITY_Mock URL Protocol|Mock URL Protocol]]
- [[_COMMUNITY_Download Command|Download Command]]
- [[_COMMUNITY_Publish Runner|Publish Runner]]
- [[_COMMUNITY_Stored Model Reference Tests|Stored Model Reference Tests]]
- [[_COMMUNITY_Component Registry|Component Registry]]
- [[_COMMUNITY_Model Row Controller|Model Row Controller]]
- [[_COMMUNITY_Filesystem & Symlink Edge Cases|Filesystem & Symlink Edge Cases]]
- [[_COMMUNITY_Availability Aggregator Tests|Availability Aggregator Tests]]
- [[_COMMUNITY_Download Command Tests|Download Command Tests]]
- [[_COMMUNITY_Model Listing & Discovery|Model Listing & Discovery]]
- [[_COMMUNITY_Delete Model Tests|Delete Model Tests]]
- [[_COMMUNITY_Hydrate Component Tests|Hydrate Component Tests]]
- [[_COMMUNITY_Ship Dry-Run Tests|Ship Dry-Run Tests]]
- [[_COMMUNITY_Tool Check Tests|Tool Check Tests]]
- [[_COMMUNITY_Manifest Command|Manifest Command]]
- [[_COMMUNITY_Bundle Test Fixtures|Bundle Test Fixtures]]
- [[_COMMUNITY_Models List UI|Models List UI]]
- [[_COMMUNITY_Component Catalog Queries Tests|Component Catalog Queries Tests]]
- [[_COMMUNITY_Manifest Error Mode Tests|Manifest Error Mode Tests]]
- [[_COMMUNITY_CLI Command Test Suites|CLI Command Test Suites]]
- [[_COMMUNITY_Progress Reporter|Progress Reporter]]
- [[_COMMUNITY_Operation Briefs & Plans|Operation Briefs & Plans]]
- [[_COMMUNITY_Download & Telemetry Session|Download & Telemetry Session]]
- [[_COMMUNITY_Publish Progress States|Publish Progress States]]
- [[_COMMUNITY_Availability Aggregator|Availability Aggregator]]
- [[_COMMUNITY_Component Handle|Component Handle]]
- [[_COMMUNITY_Component Auto-Hydration Tests|Component Auto-Hydration Tests]]
- [[_COMMUNITY_Registry Integrity Check Tests|Registry Integrity Check Tests]]
- [[_COMMUNITY_Download Stub URL Protocol|Download Stub URL Protocol]]
- [[_COMMUNITY_Eighth-Master Mission Docs|Eighth-Master Mission Docs]]
- [[_COMMUNITY_Process Runner|Process Runner]]
- [[_COMMUNITY_Shared Pantry Mission Docs|Shared Pantry Mission Docs]]
- [[_COMMUNITY_Stored Model Seeding|Stored Model Seeding]]
- [[_COMMUNITY_Migration Plan Tests|Migration Plan Tests]]
- [[_COMMUNITY_UI Accessibility Tests|UI Accessibility Tests]]
- [[_COMMUNITY_Delete Command Tests|Delete Command Tests]]
- [[_COMMUNITY_Ship Dry-Run Sentinel|Ship Dry-Run Sentinel]]
- [[_COMMUNITY_Async Gate Concurrency|Async Gate Concurrency]]
- [[_COMMUNITY_Model Search & Matching|Model Search & Matching]]
- [[_COMMUNITY_Download Progress Model|Download Progress Model]]
- [[_COMMUNITY_Recache Tests|Recache Tests]]
- [[_COMMUNITY_Model Row Item Tests|Model Row Item Tests]]
- [[_COMMUNITY_CDN Manifest Fetch Tests|CDN Manifest Fetch Tests]]
- [[_COMMUNITY_Credential Resolver|Credential Resolver]]
- [[_COMMUNITY_Acervo CLI & Skills|Acervo CLI & Skills]]
- [[_COMMUNITY_Telemetry Reporter|Telemetry Reporter]]
- [[_COMMUNITY_Editability Resolution|Editability Resolution]]
- [[_COMMUNITY_Decomposition Planning Docs|Decomposition Planning Docs]]
- [[_COMMUNITY_TTY Confirm Prompt|TTY Confirm Prompt]]
- [[_COMMUNITY_CDN Credentials|CDN Credentials]]
- [[_COMMUNITY_Mock URL Protocol Tests|Mock URL Protocol Tests]]
- [[_COMMUNITY_Vault Broom Mission Docs|Vault Broom Mission Docs]]
- [[_COMMUNITY_Upload Command Tests|Upload Command Tests]]
- [[_COMMUNITY_CDN Model Listing|CDN Model Listing]]
- [[_COMMUNITY_Test App Group Isolation|Test App Group Isolation]]
- [[_COMMUNITY_Stress Concurrency Tests|Stress Concurrency Tests]]
- [[_COMMUNITY_Bundle Component Smoke Tests|Bundle Component Smoke Tests]]
- [[_COMMUNITY_Download Session Injection Tests|Download Session Injection Tests]]
- [[_COMMUNITY_Whispering Wiretaps Mission Docs|Whispering Wiretaps Mission Docs]]
- [[_COMMUNITY_Filing Sergeant Mission Docs|Filing Sergeant Mission Docs]]
- [[_COMMUNITY_Catalog Hydration Tests|Catalog Hydration Tests]]
- [[_COMMUNITY_Download Interstitial Tests|Download Interstitial Tests]]
...
- [[_COMMUNITY_Generate Manifest Script|Generate Manifest Script]]
- [[_COMMUNITY_Upload Model Script|Upload Model Script]]
- [[_COMMUNITY_Version Source|Version Source]]
- [[_COMMUNITY_Bundle Contents|Bundle Contents]]
- [[_COMMUNITY_Package Manifest|Package Manifest]]
- [[_COMMUNITY_Acervo Schema|Acervo Schema]]
- [[_COMMUNITY_Release Binary Workflow|Release Binary Workflow]]
...
1. `Acervo` - 78 edges
2. `String` - 42 edges
3. `AcervoError` - 40 edges
4. `AcervoManager` - 32 edges
5. `S3CDNClient` - 32 edges
6. `ManifestGenerator` - 31 edges
7. `AcervoModelsList` - 31 edges
8. `AcervoModelTests` - 30 edges
9. `withIsolatedAcervoState()` - 30 edges
...
- `writeLocalManifest()` --calls--> `JSONEncoder`  [INFERRED]
  Tests/SwiftAcervoTests/EM2ValidityOracleTests.swift → Sources/SwiftAcervo/VerifiedMarker.swift
...
Cohesion: 0.08
Nodes (41): AcervoTelemetryReporter, AsyncThrowingStream, CDNManifest, CDNManifestFile, Double, Error, Int64, AcervoDownloadProgress (+33 more)
...
Cohesion: 0.08
Nodes (29): HTTPURLResponse, JSONEncoder, MockURLProtocol, HTTPURLResponse, String, URLRequest, URLSession, URLSessionTask (+21 more)
...
Cohesion: 0.15
Nodes (38): ContinuousClock, Duration, cleanupTempDirectory(), makeTempSharedModels(), perfActiveContainerMode(), perfApplyBaseline(), PerfBaseline, PerfBaselineEntry (+30 more)
...
### Community 12 - "S3 CDN Client Tests"
Cohesion: 0.11
Nodes (17): escaping, AcervoTelemetryReporter, Error, Sendable, String, Task, URLSession, Void (+9 more)

### Community 13 - "Downloader URL Building Tests"
Cohesion: 0.06
Nodes (17): AvailabilityEvaluator, Bool, String, ComponentDescriptor, String, AcervoDownloadProgress, AcervoTelemetryReporter, Bool (+9 more)

### Community 14 - "Path Resolution Tests"
Cohesion: 0.05
Nodes (38): Int, String, AcervoError, cdnAuthorizationFailed, cdnOperationFailed, componentFileNotFound, componentNotDownloaded, componentNotHydrated (+30 more)

### Community 15 - "Acervo Error Cases"
Cohesion: 0.14
Nodes (13): RequestLog, S3CDNClientTests, SharedStaticStateSuite.MockURLProtocolSuite, AcervoCDNCredentials, Data, HTTPURLResponse, Int, Int64 (+5 more)

### Community 16 - "Component Integration Tests"
Cohesion: 0.08
Nodes (10): AppGroupEnvironmentSuite, MockURLProtocolSuite, SharedStaticStateSuite, AcervoDownloaderTests, ProgressCollector, SharedStaticStateSuite, OfflineModeGateTests, AcervoDownloadProgress (+2 more)

### Community 17 - "Model Name Parsing Tests"
Cohesion: 0.22
Nodes (18): cleanup(), EM2DiffusersHardeningTests, EM2FluxAcceptanceTests, EM2QwenAcceptanceTests, EM2TierATests, EM2TierBTests, EM2TierCTests, file() (+10 more)
...
Cohesion: 0.16
Nodes (21): Date, String, URL, VerifiedMarker, cleanup(), HashInvocationSpy, makeManifest(), makeTempBase() (+13 more)
...
Cohesion: 0.21
Nodes (13): Entry, ManifestSnapshotBox, PublishModelTests, S3RequestLog, SharedStaticStateSuite.MockURLProtocolSuite, AcervoCDNCredentials, CDNManifest, Data (+5 more)

### Community 24 - "Three-State Availability Tests"
Cohesion: 0.24
Nodes (13): FileHandle, SHA256, Bool, Int, String, URL, Group, GroupReport (+5 more)
...
Cohesion: 0.17
Nodes (21): Docs/ARCHITECTURE.md, Docs/CDN_ARCHITECTURE.md, CDN Configuration, Docs/CONTRIBUTING.md, .aimodel Format, Core AI Runtime, Docs/DESIGN_PATTERNS.md, Handoff: Reshard into Acervo (+13 more)
...
Cohesion: 0.21
Nodes (12): AcervoCDNCredentials, MultiComponentSpec, ShipCommand, HuggingFaceClient, MultiComponentSpec, AcervoCDNCredentials, Bool, HuggingFaceClient (+4 more)
...
### Community 34 - "EnsureAvailable Integration Tests"
Cohesion: 0.14
Nodes (9): CDNManifest, Int, String, URL, Key, ManifestCache, ManifestSchemaExtensionTests, Bool (+1 more)

### Community 35 - "Multi-File Rollback Tests"
Cohesion: 0.17
Nodes (12): AcervoCDNCredentials, Bool, Data, Date, String, URL, URLRequest, PayloadHash (+4 more)

### Community 36 - "Project Documentation Files"
Cohesion: 0.20
Nodes (13): cleanup(), EnsureAvailableManifestTests, GCEmptyModelDirectoriesTests, ListModelsFilterTests, makeRealModelDir(), makeStubDir(), makeTempBase(), sha256Hex() (+5 more)
...
Cohesion: 0.17
Nodes (11): DeleteFromCDNTests, SharedStaticStateSuite.MockURLProtocolSuite, State, AcervoCDNCredentials, Data, HTTPURLResponse, Int, MockURLProtocol (+3 more)
...
Cohesion: 0.15
Nodes (8): AcervoViewRenderTests, AcervoModelRowItem, async, Double, ModelAvailability, Sendable, Void, V

### Community 42 - "Component Access Tests"
Cohesion: 0.15
Nodes (5): KeepOrphansCaptureBox, UploadCommandTests, Bool, String, URL
...
### Community 47 - "CDN Publish & Delete Progress"
Cohesion: 0.23
Nodes (7): ComponentCatalogTests, ComponentDescriptor, ComponentFile, ComponentType, Int64, String, URL

### Community 48 - "Auto-Hydrate Tests"
Cohesion: 0.29
Nodes (5): SafetensorsResharderTests, Data, Int, String, URL

### Community 49 - "CDN Manifest Tests"
Cohesion: 0.17
...
### Community 50 - "Resumable Download Tests"
Cohesion: 0.24
Nodes (7): ComponentDownloadTests, ComponentDescriptor, ComponentFile, Data, Int64, String, URL

### Community 51 - "Slug EnsureAvailable Tests"
Cohesion: 0.26
Nodes (8): SharedStaticStateSuite.MockURLProtocolSuite, SlugDeleteModelTests, Bool, CDNManifest, CDNManifestFile, Data, String, URL

### Community 52 - "Telemetry Event Types"
Cohesion: 0.26
Nodes (13): AcervoCDNCredentials, AcervoDeleteProgress, AcervoPublishProgress, AcervoTelemetryReporter, Bool, CDNManifest, CDNManifestFile, S3CDNClient (+5 more)

### Community 53 - "Upload Command Tests"
Cohesion: 0.25
Nodes (6): AutoHydrateTests, SharedStaticStateSuite.MockURLProtocolSuite, CDNManifest, ComponentDescriptor, String, URL

### Community 55 - "Telemetry Integrity Failure Tests"
Cohesion: 0.35
Nodes (7): ResumableDownloadTests, SharedStaticStateSuite.MockURLProtocolSuite, CDNManifestFile, Data, Int, String, URL

### Community 56 - "Manifest Persistence Tests"
Cohesion: 0.29
Nodes (7): SharedStaticStateSuite.MockURLProtocolSuite, SlugEnsureAvailableTests, CDNManifest, CDNManifestFile, Data, String, URL

### Community 57 - "Recache Command"
Cohesion: 0.10
Nodes (20): AcervoTelemetryEvent, cacheHit, cacheMiss, cdnRequest, componentDownloadComplete, componentDownloadStart, componentFileAccessOpened, componentResolveComplete (+12 more)
...
Cohesion: 0.13
Nodes (19): Acervo Static API, acervo CLI Tool, AcervoManager Actor, HuggingFaceClient, SwiftAcervo CLAUDE.md, SecureDownloadSession, Acervo.isModelAvailable, Acervo.sharedModelsDirectory (+11 more)

### Community 60 - "Component In-Flight Tests"
Cohesion: 0.14
Nodes (11): AcervoModelRowItem, async, Date, Double, Error, ModelAvailability, Sendable, String (+3 more)
...
Cohesion: 0.24
Nodes (8): VerifyCommand, JSONDecoder, CDNManifest, Data, ProgressOptions, String, URL, URLSession
...
Cohesion: 0.15
Nodes (3): ShipCommandTests, String, URL
...
Cohesion: 0.26
Nodes (7): ChunkedDownloadStreamTests, ProgressCollector, AcervoDownloadProgress, Data, String, URL, URLSession

### Community 74 - "Stored Model Edit Sheet Tests"
Cohesion: 0.23
Nodes (4): SigV4SignerTests, AcervoCDNCredentials, Date, SigV4Signer

### Community 75 - "In-Flight Downloads Dedup"
Cohesion: 0.26
Nodes (6): ProcessEnvironmentSuite, ShipReshardTests, CDNManifest, Int, String, URL
...
Cohesion: 0.16
Nodes (7): LocalizedError, DownloadStub, StubError, AcervoModelRowController, Bool, ModelAvailability, String

### Community 78 - "Download Progress Tests"
Cohesion: 0.21
Nodes (12): MainActor, AcervoModelRowController, AcervoModelRowItem, async, Bool, Double, LocalizedStringKey, ModelAvailability (+4 more)
...
Cohesion: 0.21
Nodes (10): Error, AcervoModelRowController, AcervoModelRowItem, Error, LocalizedStringKey, Sendable, URL, AcervoModelDownloadRow (+2 more)
...
Cohesion: 0.25
Nodes (10): Bool, LocalizedStringKey, String, Void, AcervoStoredModelEditSheet, Draft, Labels, Mode (+2 more)
...
Cohesion: 0.18
Nodes (7): ShipCommandHFStubURLProtocol, ShipPublishCallBox, TestSentinelError, publishShouldNotBeCalled, Bool, URLRequest, URLProtocol
...
Cohesion: 0.32
Nodes (6): DownloadCommand, Bool, HuggingFaceClient, ProgressOptions, String, URL
...
Cohesion: 0.26
Nodes (10): AcervoModelRowItem, async, Double, LocalizedStringKey, ModelAvailability, Sendable, String, Void (+2 more)
...
Cohesion: 0.28
Nodes (5): AcervoModelRowControllerTests, TestClock, TestClock, Date, TimeInterval
...
Cohesion: 0.45
Nodes (4): Bool, ModelAvailability, String, URL

### Community 112 - "Models List UI"
Cohesion: 0.32
Nodes (6): AcervoTelemetryReporter, Double, Int64, String, ModelDownloadManager, ModelDownloadProgress
...
Cohesion: 0.20
Nodes (11): Integrity Checkpoint Completion Log, Integrity Checkpoint Execution Plan, Torrent Tribunal Execution Plan, Integrity Checkpoint Mission Brief, Torrent Tribunal Mission Brief, Model Integrity Requirements, Download Performance Requirements, Integrity Checkpoint Supervisor State (+3 more)
...
Cohesion: 0.22
Nodes (5): ChunkingMockURLProtocol, Plan, Bool, Int, URLRequest
...
Cohesion: 0.29
Nodes (3): DownloadCommandStubURLProtocol, Bool, URLRequest

### Community 135 - "Download Progress Model"
Cohesion: 0.32
Nodes (5): CheckedContinuation, Never, AsyncGate, CheckedContinuation, Void
...
### Community 150 - "Test App Group Isolation"
Cohesion: 0.47
...
### Community 153 - "Download Session Injection Tests"
Cohesion: 0.33
Nodes (5): Bool, Editability, automatic, editable, readOnly

### Community 154 - "Whispering Wiretaps Mission Docs"
Cohesion: 0.33
Nodes (5): ModelAvailability, available, downloading, notAvailable, partial

### Community 155 - "Filing Sergeant Mission Docs"
Cohesion: 0.40
Nodes (4): PublicRequestLog, HTTPURLResponse, Int, URLRequest

### Community 156 - "Catalog Hydration Tests"
Cohesion: 0.50
...
### Community 157 - "Download Interstitial Tests"
Cohesion: 0.40
Nodes (3): TTYConfirm, Bool, String

### Community 158 - "CLI Requirements Docs"
Cohesion: 0.60
Nodes (3): String, URL, AcervoCDNCredentials

### Community 160 - "Start Script"
Cohesion: 0.70
...
- `AGENTS.md v0.7.2 (Monolithic, Archived)` → `SwiftAcervo Requirements (v2: Component Registry)`  [AMBIGUOUS]
  Docs/complete/REQUIREMENTS.md · relation: semantically_similar_to
- `AGENTS.md v0.7.2 (Monolithic, Archived)` → `Operation Swift Ascendant — Brief`  [AMBIGUOUS]
  Docs/complete/swift_ascendant_01_BRIEF.md · relation: references
- `OPERATION SHARED PANTRY — Iteration 01 Brief` → `OPERATION TICKET STUB — Iteration 01 Brief`  [AMBIGUOUS]
  Docs/complete/shared-pantry-01/OPERATION_SHARED_PANTRY_01_BRIEF.md · relation: conceptually_related_to
- `Acervo Decomposition Requirements` → `Test-Models Directory Override Proposal`  [AMBIGUOUS]
  Docs/queue/0001-test-models-directory-override.md · relation: conceptually_related_to
- `Download Performance Requirements` → `Model Integrity Requirements`  [AMBIGUOUS]
  Docs/incomplete/integrity-checkpoint-01/REQUIREMENTS-model-integrity.md · relation: references

## Knowledge Gaps
- **521 isolated node(s):** `AcervoCDNCredentials`, `String`, `ProgressOptions`, `URL`, `AcervoDeleteProgress` (+516 more)
...
- **What is the exact relationship between `AGENTS.md v0.7.2 (Monolithic, Archived)` and `SwiftAcervo Requirements (v2: Component Registry)`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **What is the exact relationship between `AGENTS.md v0.7.2 (Monolithic, Archived)` and `Operation Swift Ascendant — Brief`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **What is the exact relationship between `OPERATION SHARED PANTRY — Iteration 01 Brief` and `OPERATION TICKET STUB — Iteration 01 Brief`?**
...
- **What is the exact relationship between `Acervo Decomposition Requirements` and `Test-Models Directory Override Proposal`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Download Performance Requirements` and `Model Integrity Requirements`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `VerifiedMarker` connect `Model Availability Tests` to `CDN S3 Client & Credentials`, `Model Row UI Controller`, `CLI Tool Errors`, `Publish Model Tests`, `Models List UI Components`, `Bundle Test Fixtures`, `Verify Command`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `MockTelemetryReporter` connect `Manifest Command Tests` to `Model Row UI Controller`, `Mock URL Protocol Tests`, `HuggingFace Client Tests`?**
