...
- `Acervo.fetchManifest(for:)` — public wrapper that returns the raw `CDNManifest` without touching the registry. For custom catalogs, cache warmers, and CI verification tools.
