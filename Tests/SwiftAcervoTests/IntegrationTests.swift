...
// endpoint. These tests compile unconditionally but skip at runtime
// unless the INTEGRATION_TESTS environment variable is set.
//
// To run integration tests:
//   INTEGRATION_TESTS=1 xcodebuild test -scheme SwiftAcervo \
