...
`RUNNING` — S12 COMPLETED (commit c9a3320); S13 PENDING.
...
- Work unit state: RUNNING (S1–S12 COMPLETED; S13–S15 queued)
- Current sortie: S13 of 15 (PENDING)
- Last completed: S12 — sortie state COMPLETED at commit c9a3320
