...
`RUNNING` — S7 COMPLETED (commits 8a29498 + 538671e); S8 PENDING.
...
- Work unit state: RUNNING (S1–S7 COMPLETED; S8–S15 queued)
- Current sortie: S8 of 15 (PENDING)
- Last completed: S7 — sortie state COMPLETED at commits 8a29498 + 538671e
