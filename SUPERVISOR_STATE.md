...
`RUNNING` — S11 COMPLETED (commit 47b9374); S12 PENDING.
...
- Work unit state: RUNNING (S1–S11 COMPLETED; S12–S15 queued)
- Current sortie: S12 of 15 (PENDING)
- Last completed: S11 — sortie state COMPLETED at commit 47b9374
