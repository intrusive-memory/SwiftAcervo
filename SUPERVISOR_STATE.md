...
`RUNNING` — S8 COMPLETED (commit e066116); S9 PENDING.
...
- Work unit state: RUNNING (S1–S8 COMPLETED; S9–S15 queued)
- Current sortie: S9 of 15 (PENDING)
- Last completed: S8 — sortie state COMPLETED at commit e066116
